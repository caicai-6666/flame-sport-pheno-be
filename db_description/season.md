...
### 赛季项目固定数由 required_project_count 控制

不同赛季可以要求用户选择不同数量的运动项目。

例如：

```text
2026年7月赛季：required_project_count = 3
2026年8月赛季：required_project_count = 4
```

后端在用户锁定项目、选择挑战等级和赛季结算时，都应以当前赛季的 `required_project_count` 为准。
